...
str1 = "1,홍길동,100,100,99"
s = str1.split(",") #국어['1','홍길동','100','100','99'] - 문자열
s[2] = int(s[2]) # 국어 문자를 숫자로 변경
s[3] = int(s[3])
s[4] = int(s[4])
...
print("-"*60)  #문자*반복
# # *s : 구조분해할당 (s[0],s[1],s[1],s[2],s[3],s[4],s[5],s[6])
# print("{}\t{}\t{}\t{}\t{}\t{}\t{:.2f}".format(s[0],s[1],s[1],s[2],s[3],s[4],s[5],s[6],))
# print("{}\t{}\t{}\t{}\t{}\t{}\t{:.2f}".format(*s))#구조분해할당
...
# result1 = paper.find("홍수") # 특정 단어 위치점을 찾을수있음("홍수",5)
# print(result1)
