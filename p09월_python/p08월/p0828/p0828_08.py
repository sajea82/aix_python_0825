...
# iarr = []
# # 반복문
# for i in range(5): # 다섯번을 입력 반복해준다
...
# arr = random.sample(range(1,46),5) # 1-45까지 중복없이 5개를 가져옴.(알아둘것)
# print(arr)
# arr2 = random.sample([1,2,3],2)
# print(arr2)
# arr3 = [1,2,3,4,5]
# arr3 = random.shuffle(arr3)
# print(arr3)

# arr4 = [1,2,3,4,5]
# arr5 = random.choices(arr4,k=3) # 리스트 해당개수 만큼 가져옴. 중복가능(chlices)
# print(arr5)
