alist = list(range(1,21))      # 자바,c
nlist = []
for a in alist:
    if a%3==0: nlist.append(a)
print(nlist)

a = [n for n in range(1,21) if n%3==0] # 파이썬만 가능 (리스트내포)
print(a)
...
# import operator
# name_sort1 = []
# # name_sort1 = sorted(name_dic.items(),key=lambda x:x[1]) # 0 : key, 1: value
...
# stu_list = [
#     {"no":1,"name":"홍길동","kor":100,"eng":100,"math":100,"music":100,"total":400,"avg":100.0},
#     {"no":2,"name":"유관순","kor":100,"eng":100,"math":100,"music":100,"total":400,"avg":100.0},
#     {"no":3,"name":"이순신","kor":100,"eng":100,"math":100,"music":100,"total":400,"avg":100.0},
# ]
